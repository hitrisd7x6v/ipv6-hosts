...
5. [项目预览地址](http://demo.iteaj.com/) 以及配套的 [java后端项目](https://gitee.com/iteaj/izone-sboot) 和 [代码生成器](http://online.iteaj.com)
6. 最后说一句这确实是一个好项目，不管是学习如何编写vue组件还是直接在项目上使用，总之一句话用过才知道(请自行体验，交流群：616124620) 
