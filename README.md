### ivzone([预览地址 _【数据全部用mock模拟】_ ](http://ivzone.iteaj.com/#/)) 是基于vite2.0+vue3.0+antdv2+vuex4.0+vuerouter4开发的一套后台模板，并且包含一套通用的增删改查组件库，此组件库具有 实现优雅、代码简洁、通俗易懂、开发效率高、代码量减少30%+等优点
