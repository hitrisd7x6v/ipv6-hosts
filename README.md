...
此次更新不兼容1.0版本，是重新出发重新整理的一个版本，使用单页面架构(spa). 此版本对antd2的一些常用组件进行了简易封装比如：表格，表单。并且提供了增删改查视图页组件，模态框编辑框组件以及其他组件；在后续将会提供更多的简单方便且灵活的组件。还有此版本是一个纯前端版， 没有和任何后端继承，基于java后端的集成版本还在开发适配中
#### 框架核心功能
...
#### 软件架构
使用vue3+antd2+vuex4+vuerouter4框架以及ui组件库， 没有其余的强依赖
